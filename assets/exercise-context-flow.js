(function () {
  ...
  var CONTEXTS = {
    ...
    "grocery-list-ai": ["p1-e2", "phase1", "video", "Try the same task with AI", "Compare your own sorting choices with an AI-assisted approach and notice what the prompt makes clear.", "https://drive.google.com/file/d/1gnQt4DosE77dUAlRw_Lz7Zg0iM7WoqSH/view?usp=vids_web"],
    "rushed-voice-memo": ["p1-e4", "phase1", "video", "Hugh needs a favor", "Hugh needs a favor and the information is messy. Slow the situation down and make the request easier to understand.", "https://drive.google.com/file/d/1UlgI50nxlmc-K5DcrjUnnn_-yjghwlQM/view?usp=vids_web"],
    "rushed-voice-memo-ai": ["p1-e5", "phase1", "video", "Try the same memo with AI", "Compare your restructuring choices with another structured draft before using AI.", "https://drive.google.com/file/d/1S37Vsw2Ga4noX0nVFxv44_9-8uxfqdrS/view?usp=vids_web"],
    "chalkboard-notes": ["p1-e6", "phase1", "video", "Aiko needs the Olympic brainstorm sorted", "Turn the brainstorm fragments into something the team can use. Clean up the clutter and make the structure visible.", "https://drive.google.com/file/d/1hYPC8eCn9fCDFDEo0WgMt3qva2pyQXV7/view?usp=vids_web"],
