...
(function () {
  ...
  function videoAccessHelp() {
    ...
    return '<details class="ws-video-access-help"><summary><span>Video not opening?</span><small>Check access</small></summary><div class="ws-access-help-body"><p class="ws-access-warning"><strong>Do not request access to each video.</strong> Your access is handled through your membership record.</p><ol><li><strong>Use the right Google account:</strong> Make sure you are signed into Google with the same email you use for this workspace.' + emailText + '</li><li><strong>Refresh the workspace:</strong> Return here and refresh this page. New access can take a few minutes to apply.</li><li><strong>Still blocked?</strong> Reply to your welcome email and ask Wen-Szu to check your video access.</li></ol><div class="ws-access-shot-row" aria-label="Video access visual guide"><div class="ws-access-shot"><strong>1. Check account</strong><span>Use the same Google email as your member login.</span></div><div class="ws-access-shot"><strong>2. Refresh page</strong><span>Reload the workspace after a few minutes.</span></div><div class="ws-access-shot"><strong>3. Ask for help</strong><span>Reply to your welcome email if videos are still blocked.</span></div></div></div></details>';
  }
