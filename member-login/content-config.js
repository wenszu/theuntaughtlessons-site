...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".ws-brand{display:flex;align-items:center;gap:14px;min-width:0}.ws-logo-link{display:flex;align-items:center;border-radius:6px}.ws-logo-link:hover{background:rgba(238,163,32,.18)}.ws-logo{height:31px;width:auto;display:block}.ws-brand-sep,.ws-workspace-link,.ws-nav-divider{display:none}.ws-program-name{font:700 11px 'Roboto Mono',monospace;letter-spacing:.06em;text-transform:uppercase;color:var(--ws-gold)}",
  ...
  function navHtml(active) {
    ...
    return '<header class="ws-nav"><div class="ws-nav-inner">' +
      '<div class="ws-brand"><a class="ws-logo-link" href="' + homeHref() + '" aria-label="The Untaught Lessons home"><img class="ws-logo" src="' + assetHref("../assets/utl-logo-nav-white.png") + '" alt="The Untaught Lessons"></a><span class="ws-program-name">Think. Speak. Act.™</span></div>' +
