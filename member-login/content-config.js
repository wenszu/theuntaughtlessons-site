const UTL_CONTENT = {
  welcomeWalkthrough: {
    steps: [
      ...
      { id: "phases", title: "Think clearly, speak concisely, act confidently.", body: "Each phase pairs a few short videos with hands on exercises. Watch a video, then immediately put it to work on a task set inside Aiko's company. Move through all three phases at your own pace, whenever you have time.", screenshot: { src: "../assets/walkthrough/program-path-20260816.png", alt: "The Program path section on the Learning Journey page, with the 6-step progress dots highlighted", capturedOn: "2026-08-16", cutout: { top: "27.72%", left: "82.56%", width: "15.13%", height: "13.04%" } } },
