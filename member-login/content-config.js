...
(function () {
  ...
  function currentUser() {
    ...
    return {
      email: email,
      label: profile.firstName ? [profile.firstName, profile.lastName].filter(Boolean).join(" ") : email,
      initials: initials(profile.firstName || email),
  ...
  function navHtml(active) {
    ...
    var adminSection = user.role === "admin" ? '<div class="ws-profile-section"><span class="ws-profile-section-label">Admin access</span><a class="ws-admin-link" href="' + adminHref() + '">Open admin console</a></div>' : "";
    var links = [
      ...
      { key: "results", label: "My Results", href: "../my-results/index.html" },
      { key: "toolkit", label: "Toolkit", href: "../apps/toolkit/index.html" }
    ...
    return '<header class="ws-nav"><div class="ws-nav-inner">' +
      ...
      '<div class="ws-user"><span class="ws-user-email">' + escapeHtml(user.email) + '</span><button class="ws-avatar" type="button" aria-label="Open profile menu" aria-expanded="false">' + escapeHtml(user.initials) + '</button><div class="ws-profile-menu" hidden><p class="ws-profile-name">' + escapeHtml(user.label) + '</p><p class="ws-profile-email">' + escapeHtml(user.email) + '</p><div class="ws-profile-divider"></div><a href="' + memberHref("index.html") + '">Member workspace</a>' + adminSection + '<button class="ws-logout" type="button">Log out</button></div></div>' +
      '</div></header>';
  }
