...
(function () {
  ...
  function engagementAnalyticsHref() {
    if (inPhasePracticeRoot()) return "../../../assets/engagement-analytics.js?v=20260915-cache-v2";
    return "../assets/engagement-analytics.js?v=20260915-cache-v2";
  }
