...
(function () {
  ...
  function rewardUiHref() {
    var version = "?v=20260711-rewards-ui-8";
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".ws-mission-nav{position:relative;cursor:pointer}.ws-mission-popover{position:absolute;right:0;top:calc(100% + 12px);z-index:9990;width:320px;padding:16px 18px;border:1px solid rgba(238,163,32,.42);border-radius:12px;background:#fff;color:var(--ws-charcoal);box-shadow:0 18px 48px rgba(0,51,102,.22);opacity:0;pointer-events:none;transform:translateY(-6px);transition:opacity .16s ease,transform .16s ease;white-space:normal;text-align:left}.ws-mission-nav:hover .ws-mission-popover,.ws-mission-nav:focus-within .ws-mission-popover{opacity:1;pointer-events:auto;transform:translateY(0)}.ws-mission-popover small{display:block;color:var(--ws-gold);font:700 10px 'Roboto Mono',monospace;letter-spacing:.12em;text-transform:uppercase}.ws-mission-popover>strong{display:block;margin-top:5px;color:var(--ws-navy);font:700 18px Lato,sans-serif}.ws-mission-popover p{margin:7px 0 12px;color:var(--ws-steel);font:700 13px/1.4 Lato,sans-serif}.ws-mission-popover ul{display:grid;gap:7px;margin:12px 0;padding:0;list-style:none}.ws-mission-popover li{display:grid;grid-template-columns:18px 1fr;gap:6px;color:var(--ws-navy);font:700 13px/1.3 Lato,sans-serif}.ws-mission-popover li.ws-done{color:var(--ws-green)}.ws-mission-popover>a,.ws-mission-popover-actions a{display:inline-flex;align-items:center;justify-content:center;min-height:38px;border-radius:7px;background:var(--ws-gold);color:var(--ws-navy);padding:0 12px;text-decoration:none;font:700 11px Lato,sans-serif;text-transform:uppercase}.ws-mission-popover-actions{display:flex!important;align-items:center;justify-content:flex-end;gap:8px;margin-top:12px}.ws-mission-popover-actions b{color:var(--ws-green);font:700 12px Lato,sans-serif}@media(max-width:620px){.ws-mission-popover{position:fixed;top:94px;right:12px;width:calc(100vw - 24px);max-height:calc(100svh - 112px);overflow:auto}}",
      ...
      ".ws-practice-body>.ws-context-embed,.ws-practice-pane .ws-context-embed{margin-bottom:22px}.ws-card-actions{display:grid;gap:22px;justify-content:stretch;margin-top:22px}.ws-card-actions .ws-button{width:100%;min-width:0}.ws-mark-incomplete{justify-self:center;border:0;background:transparent;color:var(--ws-steel);font:700 12px Lato,sans-serif;text-decoration:underline;text-underline-offset:3px;cursor:pointer;padding:4px 8px}.ws-mark-incomplete:hover{color:var(--ws-navy)}",
