...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".ws-practice-body>.ws-context-embed,.ws-practice-pane .ws-context-embed{margin-bottom:22px}.ws-card-actions{display:grid;gap:10px;justify-content:stretch;margin-top:22px}.ws-card-actions .ws-button{width:100%;min-width:0}.ws-mark-incomplete{justify-self:center;border:0;background:transparent;color:var(--ws-steel);font:700 12px Lato,sans-serif;text-decoration:underline;text-underline-offset:3px;cursor:pointer;padding:4px 8px}.ws-mark-incomplete:hover{color:var(--ws-navy)}",
