...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".ws-user{position:relative;display:flex;align-items:center;gap:10px;justify-content:flex-end}.ws-user-email{max-width:170px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:rgba(255,255,255,.68);font:700 10px 'Roboto Mono',monospace;letter-spacing:.06em}.ws-avatar{width:36px;height:36px;border-radius:999px;border:0;background:var(--ws-gold);color:var(--ws-navy);display:grid;place-items:center;font:700 12px 'Roboto Mono',monospace;cursor:pointer;overflow:hidden;padding:0}.ws-avatar img,.ws-profile-avatar img{width:100%;height:100%;object-fit:cover;display:block}.ws-profile-menu{position:absolute;right:0;top:46px;width:234px;background:#fff;color:var(--ws-charcoal);border:1px solid var(--ws-line);border-radius:9px;box-shadow:0 18px 40px rgba(0,51,102,.22);padding:0;z-index:50;overflow:hidden}.ws-profile-menu:before{content:'';position:absolute;top:-8px;right:18px;width:16px;height:16px;background:var(--ws-navy);transform:rotate(45deg)}.ws-profile-menu[hidden]{display:none}.ws-profile-head{position:relative;display:flex;align-items:center;gap:12px;background:var(--ws-navy);color:#fff;padding:18px 16px 17px;border-bottom:3px solid var(--ws-gold)}.ws-profile-avatar{width:40px;height:40px;border-radius:999px;background:var(--ws-gold);color:var(--ws-navy);display:grid;place-items:center;overflow:hidden;font:700 12px 'Roboto Mono',monospace;flex:0 0 auto}.ws-profile-name{margin:0;color:#fff;font-weight:700;line-height:1.15}.ws-profile-role{margin:4px 0 0;color:var(--ws-gold);font:700 9px 'Roboto Mono',monospace;letter-spacing:.12em;text-transform:uppercase}.ws-profile-section{padding:14px 16px 12px;border-bottom:1px solid var(--ws-line)}.ws-profile-section:last-child{border-bottom:0}.ws-profile-section-label{display:block;margin:0 0 8px;color:var(--ws-gold);font:700 9px 'Roboto Mono',monospace;letter-spacing:.12em;text-transform:uppercase}.ws-profile-menu a,.ws-profile-menu button{width:100%;min-height:34px;display:flex;align-items:center;gap:12px;border:0;background:transparent;color:var(--ws-navy);font:700 13px Lato,sans-serif;text-align:left;text-decoration:none;cursor:pointer;padding:5px 0}.ws-profile-menu a:hover,.ws-profile-menu button:hover{text-decoration:underline}.ws-profile-icon{width:15px;color:var(--ws-steel);display:inline-flex;justify-content:center}.ws-profile-menu .ws-admin-link .ws-profile-icon{color:var(--ws-gold)}.ws-profile-menu .ws-logout{color:var(--ws-steel)}",
