...
assert(!admin.includes('id="section-admin-preview"'), 'the standalone admin-preview-bypass toggle is folded into Member preview settings');
assert(admin.includes('Unlock all phases for admin preview'), 'the admin-preview-bypass toggle still exists, now inside Member preview settings');
