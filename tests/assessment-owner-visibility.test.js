...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=[\w-]+/, 'every member shell should load a cache-busted copy of the role-aware assessment journey code'));
