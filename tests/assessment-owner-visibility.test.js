...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260902-cohort-standing-tour/, 'every member shell should load the current role-aware assessment journey code'));
