...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260816-walkthrough-content-v2/, 'every member shell should load the current role-aware assessment journey code'));
