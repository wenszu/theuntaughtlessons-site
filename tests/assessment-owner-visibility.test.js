...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260907-vimeo-lessons-2/, 'every member shell should load the current role-aware assessment journey code'));
