...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260817-header-card/, 'every member shell should load the current role-aware assessment journey code'));
