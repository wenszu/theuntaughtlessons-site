...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260828-credential-sharing-1/, 'every member shell should load the current role-aware assessment journey code'));
