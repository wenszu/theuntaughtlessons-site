...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260819-program-icon-size/, 'every member shell should load the current role-aware assessment journey code'));
