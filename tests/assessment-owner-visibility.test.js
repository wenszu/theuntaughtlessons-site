...
memberShells.forEach(shell => assert.match(shell, /content-config\.js\?v=20260907-vimeo-pilot/, 'every member shell should load the current role-aware assessment journey code'));
