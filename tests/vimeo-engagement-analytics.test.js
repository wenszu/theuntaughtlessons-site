...
assert.match(workspace, /VIMEO_COMPLETION_PERCENT = 80/);
...
assert.match(workspace, /completed: percent >= VIMEO_COMPLETION_PERCENT/, 'Vimeo completion should use the shared threshold');
...
assert.match(admin, /source:'vimeo-80-percent'/);
