...
assert(rewardUi.includes('Save reflection and continue'), 'reflection has a deliberate completion action');
...
assert(workspace.includes('PROGRAM_COMPLETION_MP = 200'), 'workspace fallback uses the approved 200 MP bonus');
