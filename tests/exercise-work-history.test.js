...
assert.match(phase1History, /phase1-work-actions\{display:flex;align-items:center;flex-wrap:wrap/);
assert.match(phase1History, /phase1-work-actions select\{flex:1 1 240px;width:100%;min-width:min\(240px,100%\)\}/);
...
assert.match(nativeHistory, /native-work-actions\{display:flex;align-items:center;flex-wrap:wrap/);
assert.match(nativeHistory, /native-work-actions select\{flex:1 1 240px;width:100%;min-width:min\(240px,100%\)\}/);
